...
LABEL="node-role.kubernetes.io/master" # The node label to multinode-optimist OVN DB
...
chmod +x /opt/bin/kubectl-ko
echo "-------------------------------"
echo ""

if ! sh -c "echo \":$PATH:\" | grep -q \":/opt/bin:\""; then
  echo "Tips:Please join the /opt/bin to your PATH. Temporarily, we do it for this execution."
